<template>
  <div>
    <div class="bg-base-200 h-screen">
      <div class="pt-8 mx-auto"><h1 class="title">About</h1></div>
      <div class="divider w-96 mx-auto"></div>
      <div class="card glass w-96 bg-base-100 shadow-xl mx-auto my-8">
        <div class="card-body">
          <h2 class="card-title mx-auto text-secondary font-bold">NuxtFolio</h2>
          <p>
            This static portfolio site is built Using Nuxt 3 (powered by Vue 3)
            alongside DaisyUI (powered by TailwindCSS) as the component library.
            Hosting is handled by Firebase v9.
          </p>
          <a
